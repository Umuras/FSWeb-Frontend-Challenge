...
export function Header() {
  ...
  return (
    <div className={darkMode ? "dark" : ""}>
      <div className="flex justify-end mr-[12rem] mt-[1rem] items-center max-[960px]:justify-center max-[960px]:mb-[1rem]">
        <label
          className={
